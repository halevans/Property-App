...
import { deleteOffer } from '../ApiConfig/api';
  ...
  return (
    <Accordion.Body>
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <Button onClick={handleOfferDelete} variant="primary" size="sm">Delete Offer <i className="bi bi-plus-circle-fill ml-2"></i></Button>
      </div>
    </Accordion.Body>
  );
  }
