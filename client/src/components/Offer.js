  ...
  return (
    <Accordion.Body className='p-2'>
      {props.offer.user_id === props.user.id ? <div style={{ display: 'flex', justifyContent: 'space-between', backgroundColor: '#F4F9F9', padding: '5px', alignItems: 'center', borderRadius: '5px'}}>
        <p style={{ margin: '0', display: 'flex', alignItems: 'center' }}><strong>{offerDate}&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-circle-arrow-right"></i>&nbsp;&nbsp;</strong> Your Offer Amount: £{props.offer.offer_price.toLocaleString()}</p>
